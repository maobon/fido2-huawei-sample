...
public class ServerUtils {
    ...
    public static PublicKeyCredentialCreationOptions convert2PublicKeyCredentialCreationOptions(Fido2Client fido2Client, ServerPublicKeyCredentialCreationOptionsResponse response) {
        ...
        if (response.getAuthenticatorSelection() != null) {
            ...
            com.huawei.hms.support.api.fido.fido2.AuthenticatorSelectionCriteria fido2Selection = new AuthenticatorSelectionCriteria(attachment, residentKey, requirement);
        ...
        if (response.getAttestation() != null) {
            try {
                AttestationConveyancePreference preference = AttestationConveyancePreference.fromValue(response.getAttestation());
    ...
    public static PublicKeyCredentialRequestOptions convert2PublicKeyCredentialRequestOptions(Fido2Client fido2Client, ServerPublicKeyCredentialCreationOptionsResponse response, boolean isUseSelectedPlatformAuthenticator) {
