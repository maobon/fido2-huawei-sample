...
public class Fido2DemoMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean supported = fido2Client.isSupported();
        Toast.makeText(this, supported ? "设备支持" : "设备不支持", Toast.LENGTH_SHORT).show();
    }
    ...
    private void reg2Fido2Client(PublicKeyCredentialCreationOptions publicKeyCredentialCreationOptions) {
        ...
        // biometric prompt display content
        NativeFido2Options.BiometricPromptInfo biometricPromptInfo = new NativeFido2Options.BiometricPromptInfo("标题", "内容: 注册");
        NativeFido2RegistrationOptions.Builder builder = NativeFido2RegistrationOptions.builder().setBiometricPromptInfo(biometricPromptInfo);
    ...
    private void authn2Fido2Client(PublicKeyCredentialRequestOptions publicKeyCredentialCreationOptions) {
        ...
        builder.setBiometricPromptInfo(new NativeFido2Options.BiometricPromptInfo("标题", "内容: 认证"));
        NativeFido2AuthenticationOptions authenticationOptions = builder.build();

        Fido2AuthenticationRequest authenticationRequest = new Fido2AuthenticationRequest(publicKeyCredentialCreationOptions, null);
